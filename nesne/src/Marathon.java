...
public class Marathon {
    ...
    public Marathon(String[] students, int[] times) {
    ...
    public void printLowestTimeStudent() {
        int lowestTimeIndex = findLowestTimeIndex();
        System.out.println("En düşük zamanı alan öğrenci: " + students[lowestTimeIndex] + ", zamanı: " + times[lowestTimeIndex]);
    }

    public void printSecondBestTime() {
        int secondBestIndex = findSecondBestIndex();
        System.out.println("İkinci en iyi koşucunun zamanı: " + times[secondBestIndex]);
    }
